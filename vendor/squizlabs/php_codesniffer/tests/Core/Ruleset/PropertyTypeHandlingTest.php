...
final class PropertyTypeHandlingTest extends TestCase
{
     ...
     * @var string
     */
    public const SNIFF_CODE = 'TestStandard.SetProperty.PropertyTypeHandling';
     ...
     * @var string
     */
    public const SNIFF_CLASS = 'Fixtures\\TestStandard\\Sniffs\\SetProperty\\PropertyTypeHandlingSniff';
